...
void visualizeRipple(int dir, double period, double height) {
  ...
  // Bringing values down again. These are just slightly
  // above your original (invisible) values of (30, 40).
  // This should be very dim.
  int final_red = (int)(40 + (60 - 40) * fraction);
  int final_green = 0; // Always 0 for Red <-> Purple
  int final_blue = (int)(50 + (0 - 50) * fraction);
